...
// CHECK THIS
  static init() {
    ...
    h1 = baseStyle.copyWith(fontSize: AppDimensions.font(32));
    h1b = h1!.copyWith(fontWeight: b);

    h2 = baseStyle.copyWith(fontSize: AppDimensions.font(30));
    ...
    b2 = baseStyle.copyWith(fontSize: AppDimensions.font(12));
